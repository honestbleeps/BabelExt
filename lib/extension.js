      ...
      switch (instance.detectedBrowser) {
        ...
        case 'Safari':
          ...
          if (!instance.browserHistory.initialized) {
            ...
            // domain name than t he one we're browsing due to security restrictions...
...
(function(u) {
  ...
  GM_log = console.log;
    ...
    */
    ...
    var historyAddButton = document.getElementById('historyAddButton');
    if (historyAddButton) {
    ...
    var cssAddButton = document.getElementById('cssAddButton');
    if (cssAddButton) {
      cssAddButton.addEventListener('click', function() {
